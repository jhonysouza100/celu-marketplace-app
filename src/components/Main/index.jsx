    ...
    <section className="home section" id="home">
			<div className="home-container section-container grid gap-6 gap-y-10 pt-28 pb-4 lg:relative">
				<div className="home-content relative grid justify-self-center">
					<Image className="home-img sm:w-[220px] md:w-[320px] lg:w-[500px]" width={180} height={180} quality={100} src='/img/home-img.png' alt="home image"  quality={100} />
          ...
          {/* <!-- tooltip component --> */}
					<div className="home-tooltip absolute top-[-0.5rem] right-6 lg:right-[6rem]">
						<Image className="home-tooltip-img lg:w-auto" width={60} height={60} src='/img/tooltip-right.svg' alt="home tooltip image" quality={100} />
        ...
        {/* <!-- social component --> */}
        <div className="home-social grid ml-4 sm:ml-6 justify-items-center gap-y-24 absolute top-56 left-[-1.5rem] xl:left-8 md:top-0 md:bottom-0 md:place-content-center">
           ...
           <div className="home-social-links grid gap-y-6">
              <a href="#" target="_blank" className="home-social-link text-xl lg:text-2xl text-secondary transition-colors duration-300 hover:text-main" aria-label="seguir en instagram"><RiInstagramFill className="ri-instagram-fill" /></a>
              <a href="#" target="_blank" className="home-social-link text-xl lg:text-2xl text-secondary transition-colors duration-300 hover:text-main" aria-label="seguir en facebook"><RiFacebookCircleFill className="ri-facebook-circle-fill" /></a>
              <a href="#" target="_blank" className="home-social-link text-xl lg:text-2xl text-secondary transition-colors duration-300 hover:text-main" aria-label="seguir en youtube"><RiYoutubeFill className="ri-youtube-fill" /></a>
           </div>
        </div>
			</div>
		</section>
