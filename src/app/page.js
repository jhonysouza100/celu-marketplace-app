		...
		<section className="home section" id="home">
			<div className="home-container section-container grid gap-y-10 pt-28 pb-4 relative">
				<div className="home-content relative grid justify-self-center">
					...
					<h1 className="home-title text-[10rem] md:text-[16rem] md:top-[-4rem] lg:text-[25rem] flex gap-x-1 text-main absolute top-[-2rem] justify-self-center">
						<span>J</span>
						<span className="z-[-1]">B</span>
						<span>L</span>
					</h1>
					<div className="home-tooltip absolute top-[-0.5rem] right-6 lg:right-[6rem]">
						<Image className="home-tooltip-img" width={60} height={60} src='/img/tooltip-right.svg' alt="home tooltip image" />
				...
				<a href="#" class="home-button button justify-self-center lg:absolute lg:bottom-[4.5rem]">Buy Now <RiPlayCircleFill className="ri-play-circle-fill text-main"/></a>
			</div>
		</section>
